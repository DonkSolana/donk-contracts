...
import '@donkswap/core/contracts/interfaces/IUniswapV2ERC20.sol';
...
contract PitBreeder is Ownable {
    ...
    constructor(address _factory, address _pit, address _govToken, address _weth) public {
    ...
    function setBridge(address token, address bridge) external onlyOwner {
        // Checks
        require(token != govToken && token != weth && token != bridge, 'PitBreeder: Invalid bridge');
